...
public class TaskAttackPlayer : TaskWait
{
    ...
    public TaskAttackPlayer(string waitLabel, float waitTimer, PlayerController player, NightmareSkeletonController owner) : base(waitLabel, waitTimer)
    {
        this.owner = owner;
    ...
    {
        owner.headAnimator.SetTrigger("attack");
        hasAttacked = false;
